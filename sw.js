...
const APP_SHELL = [
  ...
  '/sounds/ambiente.mp3',
  // Motor de repaso espaciado, merge de estados en conflicto y evaluación
  // objetiva (ver lib/scheduling.js, lib/estado.js, lib/evaluacion.js) --
  // se cargan como <script src> antes del script principal, así que tienen
  // que estar precacheados para que la app funcione offline sin romper.
  '/lib/scheduling.js',
  '/lib/estado.js',
  '/lib/evaluacion.js',
  ...
  '/data/catalogo-agronomia.json',
  '/data/catalogo-contador-publico.json',
