...
function mergearEstados(local, remoto) {
  ...
  salida.examenes = [...ids].map(id => {
    ...
    return {
      ...
      // criterio de merge por tema que el resto -- si los dos dispositivos
      // evaluaron el MISMO tema en el conflicto, gana el remoto.
      evaluaciones:  { ...l.evaluaciones,  ...r.evaluaciones },
      flojoCount:    { ...l.flojoCount,    ...r.flojoCount },
      firmeFechas:   { ...l.firmeFechas,   ...r.firmeFechas },
